...
// ReservationStayOfferServiceModel struct for ReservationStayOfferServiceModel
type ReservationStayOfferServiceModel struct {
...
func NewReservationStayOfferServiceModel(service EmbeddedServiceModel, serviceDate string, count int32, amount AmountModel, bookedAsExtra bool, pricingMode string) *ReservationStayOfferServiceModel {
	this := ReservationStayOfferServiceModel{}
	this.Service = service
	this.ServiceDate = serviceDate
	this.Count = count
	this.Amount = amount
	this.BookedAsExtra = bookedAsExtra
...
// GetBookedAsExtra returns the BookedAsExtra field value
func (o *ReservationStayOfferServiceModel) GetBookedAsExtra() bool {
	...
	return o.BookedAsExtra
}

// GetBookedAsExtraOk returns a tuple with the BookedAsExtra field value
// and a boolean to check if the value has been set.
func (o *ReservationStayOfferServiceModel) GetBookedAsExtraOk() (*bool, bool) {
	if o == nil  {
		return nil, false
	}
	return &o.BookedAsExtra, true
}

// SetBookedAsExtra sets field value
...
func (o ReservationStayOfferServiceModel) MarshalJSON() ([]byte, error) {
	...
	if true {
		toSerialize["bookedAsExtra"] = o.BookedAsExtra
	}
	if true {
...
type NullableReservationStayOfferServiceModel struct {
	value *ReservationStayOfferServiceModel
	isSet bool
}

func (v NullableReservationStayOfferServiceModel) Get() *ReservationStayOfferServiceModel {
	return v.value
}

func (v *NullableReservationStayOfferServiceModel) Set(val *ReservationStayOfferServiceModel) {
	v.value = val
	v.isSet = true
}

func (v NullableReservationStayOfferServiceModel) IsSet() bool {
	return v.isSet
}

func (v *NullableReservationStayOfferServiceModel) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableReservationStayOfferServiceModel(val *ReservationStayOfferServiceModel) *NullableReservationStayOfferServiceModel {
	return &NullableReservationStayOfferServiceModel{value: val, isSet: true}
}

func (v NullableReservationStayOfferServiceModel) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableReservationStayOfferServiceModel) UnmarshalJSON(src []byte) error {
	v.isSet = true
